...
inductive
 mymap :: "('a * 'a) set => bool"
where
  base [simp,intro] : "mymap {}"
| step [simp,intro]: "mymap m \<Longrightarrow> mymap (m \<union> {x})"

lemma [code]: "mymap x = True" sorry

lemma "mymap a \<longrightarrow> P a"
quickcheck
*)
(* 
No code equations for mymap 
*) 
